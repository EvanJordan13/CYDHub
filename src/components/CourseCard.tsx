...
export default function CourseCard({course} : CourseCardProps) {
  return (
      <Link href="/" passHref >
         <Box height={136} width={420} bg={'white'} borderWidth={"2px"} borderColor={'lightgray'} margin={20} borderRadius={"2xl"} borderBottomWidth={"6px"} _hover={{ bg: "gray.100" }} transition={"linear"}>
