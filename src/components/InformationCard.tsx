...
export default function InformationCard({ title, description }: InformationCardProps) {
  return (
    ...
    <VStack alignItems="left">
        ...
        <Text fontWeight={700} fontSize="32px" fontFamily={"Poppins"} color="Slate">{title}</Text>
        <Text fontWeight={500} fontSize="16px" fontFamily={"Poppins"} color="Slate">{description}</Text>
    </VStack>
    </Box>
  );
}
