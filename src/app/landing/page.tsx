    ...
    <VStack w="100vw" minH="100vh" bg="white" p={8} position="relative" overflow="hidden" zIndex={-3}>
      ...
      <VStack>
        <VStack paddingY="100px">
          <Text fontSize="18px" color="Slate" fontFamily={'Poppins'} fontWeight={700}>
            Welcome to the Student Hub
          </Text>
          <Text fontSize="72px" color="Flamingo" fontWeight={700}>
            Code Your Dreams
          </Text>
        ...
        <HStack gap={60}>
          ...
          <VStack width="353px" height="221px">
            <Text fontSize="48px" color="Flamingo" fontFamily="Poppins" fontWeight={700}>
              Gamified Learning
            </Text>
            <Text fontSize="18px" color="Slate" fontWeight={500} fontFamily="Poppins">
