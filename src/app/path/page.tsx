            ...
            <Flex direction={'column'} gap={'24px'}>
              ...
              <Flex direction={'column'} gap={'16px'}>
                ...
                <Flex direction={'row'} gap={'16px'}>
                  <Flex direction={'column'} gap={'6px'}>
                    ...
                    <Box width={'165px'} height={'64px'} borderWidth={'1.5px'} borderColor={'black'}></Box>
                  </Flex>
                  ...
                  <Flex direction={'column'} gap={'6px'}>
                    ...
                    <Box width={'279px'} height={'64px'} borderWidth={'1.5px'} borderColor={'black'}></Box>
                  </Flex>
                </Flex>
              </Flex>
              <Box height={'28px'} width={'460px'} marginBottom={'16px'}>
                <Checkbox variant={'subtle'} color={'black'} colorPalette={''}>
                  ...
                  <Link color={'#4D80BB'} href="/" textDecoration={'underline'}>
                    Terms of Conditions
                  </Link>
                </Checkbox>
              </Box>
